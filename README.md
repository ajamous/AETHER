...
| Conformance harness (SGP.23)  | Implemented   | `make conformance` runs 66 cases across 10 families (incl. SAIP); coverage matrix in `tools/conformance/coverage/sgp23.md`; hardware-in-the-loop tests honestly out of scope |
