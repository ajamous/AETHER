...
| Conformance harness (SGP.23)  | Implemented   | `make conformance` runs 52 cases across 9 SGP.23 + admin-auth families; coverage matrix in `tools/conformance/coverage/sgp23.md`; hardware-in-the-loop tests honestly out of scope |
