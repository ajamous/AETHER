...
| SAS-SM evidence templates     | Implemented   | Gap analysis, key ceremony, RBAC, audit retention, AWS + GCP + Azure + on-prem reference deployments, DR runbook, incident response, common audit findings, recertification checklist — all in `docs/sas-sm/` (free, no paid tier) |
