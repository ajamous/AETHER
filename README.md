...
| Conformance harness (SGP.23)  | Implemented   | `make conformance` runs 86 cases across 10 families; coverage matrix in `tools/conformance/coverage/sgp23.md`; hardware-in-the-loop tests honestly out of scope |
